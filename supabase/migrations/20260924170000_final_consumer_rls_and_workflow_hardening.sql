...
-- Consumers are readers for online classes, exams, grades, attendance,
-- discipline, finance results and school configuration. Their only write
-- paths are the policies explicitly defined above.
