...
requirements = python3==3.11.10,hostpython3==3.11.10,kivy==2.3.1,requests==2.32.3,urllib3,certifi==2025.7.14,openpyxl==3.1.5,reportlab==4.4.4,arabic-reshaper==3.0.0,python-bidi==0.4.2
