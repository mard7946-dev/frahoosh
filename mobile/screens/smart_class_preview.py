...
class SmartClassPreviewScreen(Screen):
    ...
    def show_home(self):
        ...
        body.add_widget(self._label(
            "نمای مدیریتی کلاس هوشمند",
            "15sp", PRIMARY, 40, True
        ))
        body.add_widget(self._label(
            "مدیر می‌تواند همین محتوای واقعی را مشاهده کند و از دکمه‌های راهنما، بخش‌های کلاس را جداگانه برای دبیر، دانش‌آموز و اولیا توضیح دهد.",
            "10sp", SECONDARY, 58, True
        ))
