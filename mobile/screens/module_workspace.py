...
SUBMENUS = {
"management":[("اطلاعات مدرسه","school_profile"),("دانش‌آموزان","students"),("ملاقات و درخواست جلسات","meeting_requests"),("نمونه کلاس هوشمند / نظارت مدیر","smart_class_demo"),("دبیران","teachers"),("کادر و کارکنان","staff"),("پایه و کلاس‌ها","school_class_config"),("حساب‌های سامانه","users"),("رویدادها","school_events"),("صندوق پیام","messages"),("کارنامه‌ها","report_cards"),("برنامه هفتگی","weekly_schedule"),("آزمون آنلاین","teacher_exams"),("کلاس آنلاین","online_classes"),("مالی","finance_accounts"),("پرداخت آنلاین","payment_offers"),("تابلو هوشمند","smart_board_content"),("گزارش‌های مدیریتی","report_cards")],
"educational":[("پرونده اطلاعاتی دانش‌آموز","students"),("ملاقات‌های ارجاع‌شده","meeting_requests"),("پرونده پرسنلی همکاران","staff"),("کلاس‌های دبیران","teacher_classes"),("فعال‌سازی کلاس آنلاین","online_classes"),("برنامه هفتگی","weekly_schedule"),("برنامه امتحانی","exam_schedule"),("پیگیری آموزشی","educational_followups"),("پیگیری درسی","academic_followups"),("پیگیری انضباطی","discipline_records"),("ثبت انضباطی","discipline_records"),("نمرات و کارنامه‌ها","student_grades"),("گزارش آموزشی هوشمند","ai_smart_reports"),("جشنواره خوارزمی","khwarizmi_registrations"),("آزمون آنلاین","teacher_exams"),("صندوق پیام","messages")],
...
"advisor":[("پرونده‌های مشاوره","counseling_records"),("ملاقات با اولیا","meeting_requests"),("پیگیری جلسات","counseling_followups"),("دانش‌آموزان","students"),("اولیا","parent_children"),("درخواست ملاقات","parent_meetings"),("گزارش‌های مشاوره","report_cards"),("صندوق پیام","messages")],
"teachers":[("کلاس‌های من","teacher_classes"),("ملاقات با اولیا","meeting_requests"),("طرح درس","lesson_plans"),("برنامه هفتگی","weekly_schedule"),("کلاس‌های آنلاین فعال","online_classes"),("آزمون آنلاین","teacher_exams"),("حضور و غیاب","attendance"),("نمرات درسی","grades"),("تکالیف","assignments"),("موارد انضباطی","discipline_records"),("ارجاع دانش‌آموز","student_referrals"),("درخواست ملاقات اولیا","teacher_parent_meetings"),("صندوق پیام","messages")],
...
EDITABLE = {
    ...
    "executive": {"students","parents","parent_children","meeting_requests","staff","attendance","school_events","school_class_config","messages","weekly_schedule","monthly_report_cards","report_cards","discipline_records","certificate_requests","online_classes","program_activations"},
    ...
    "advisor": {"counseling_records","counseling_followups","meeting_requests","messages"},
    "teacher": {"meeting_requests","attendance","grades","student_grades","assignments","lesson_plans","lesson_plan_entries","teacher_exams","discipline_records","student_referrals","teacher_parent_meetings","meeting_requests","messages"},
}
...
"meeting_requests":["student_id","student_name","requester_role","target_role","target_name","requested_date_shamsi","requested_time","reason","manager_status","educational_status","status","final_date_shamsi","final_time"],
}
    ...
    def open_table(self,table,refresh_subbar=True):
        if table == "meeting_requests":
            try:
                ...
                self.status.text = rtl_text("باز کردن بخش ملاقات انجام نشد: " + str(exc))
        ...
        if table == "smart_class_demo":
            try:
                ...
                self.status.text = rtl_text("باز کردن نمونه کلاس هوشمند انجام نشد: " + str(exc))
                self.status.color = (0.8, 0.15, 0.15, 1)
                return
        self.table=table
        if refresh_subbar:
