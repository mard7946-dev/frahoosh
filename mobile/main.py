...
class FrahooshApp(App):
    ...
    def build(self):
        ...
        try:
            ...
            print("APP STATE STARTUP ERROR:", repr(exc)); self.app_state = None
        self.sm.add_widget(LoginScreen(name="login", app_state=self.app_state)); self.sm.current="login"
    ...
    def _set_screen_capture_policy(self):
        """Only management roles may capture the mobile screen."""
        try:
    ...
    def ensure_dashboard(self):
        ...
        d=DashboardScreen(name="dashboard",app_state=self.app_state); self.sm.add_widget(d); return d
    ...
    def ensure_exam(self):
        ...
        s=TeacherExamsScreen(name="teacher_exams",app_state=self.app_state); self.sm.add_widget(s); return s
    ...
    def ensure_module(self):
        ...
        s=ModuleScreen(name="module",app_state=self.app_state); self.sm.add_widget(s); return s
    ...
    def ensure_school(self):
        ...
        s=SchoolScreen(name="school",app_state=self.app_state); self.sm.add_widget(s); return s
    ...
    def ensure_update(self):
        ...
        s=UpdateScreen(name="update",app_state=self.app_state); self.sm.add_widget(s); return s
    ...
    def open_dashboard(self):
        try:
            ...
            print("DASHBOARD OPEN ERROR:",repr(exc)); return False
