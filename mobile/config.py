...
_BACKGROUND_CANDIDATES = [
    Path(os.environ.get("FRAHOOSH_BACKGROUND_PATH")) if os.environ.get("FRAHOOSH_BACKGROUND_PATH") else None,
    ASSETS_DIR / "frahoosh_login_background.png",
    ASSETS_DIR / "frahoosh_background.jpg",
    ASSETS_DIR / "school_logo.jpg",
]
BACKGROUND_PATH = next((str(p) for p in _BACKGROUND_CANDIDATES if p and p.is_file()), str(ASSETS_DIR / "frahoosh_background.jpg"))
API_TIMEOUT = 15
